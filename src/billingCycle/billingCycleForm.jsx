        ...
        return (
            <form role="form" onSubmit={handleSubmit}>
                <div className='box-body'>
                    <Field name='name' component={labelAndInput} readOnly={readOnly} type='text' label='Nome' cols='12 4' placeholder='Informe o nome' />
                    ...
                    <ItemList cols='12 6' list={debts} readOnly={readOnly} field='debts' legend='Débtos' showStatus={true} />
                </div>
